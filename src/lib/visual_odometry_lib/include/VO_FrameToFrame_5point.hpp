...
namespace vlo {
/**
 * @brief The VO_FrameToFrame_5point class declares the Visual Odometry based on
 * 5 point algorithm.
 */
class VO_FrameToFrame_5point : public IVisualOdometer {
 public:
  /**
   * @brief Pointer for an interface.
   */
  using Ptr = std::shared_ptr<VO_FrameToFrame_5point>;
  /**
   * @brief Constructor
   ...
   */
  VO_FrameToFrame_5point(const cv::Ptr<cv::DescriptorMatcher> &matcher,
   ...
   */
  ~VO_FrameToFrame_5point() = default;
  /**
